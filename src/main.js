...
function paintFineFringe(q,player){q.fillStyle=colorCss(player.appearance.hair);
  if(player.name==='萝姐'){
    ...
    canvasPolygon(q,[[8,12],[18,9],[29,12],[35,18],[33,28],[28,38],[24,45],[20,34],[17,27],[13,36],[9,31]]);
    canvasPolygon(q,[[29,11],[42,9],[55,13],[56,30],[51,36],[47,28],[43,21],[39,34],[34,43],[31,28]]);
